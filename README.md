# esp32code
below contains the whole code for the esp32 that controls all of the sensors and components connected and also has the IoT connected to the companion application
